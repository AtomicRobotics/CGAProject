...
class ShaderProgram(vertexShaderPath: String, fragmentShaderPath: String) {
    ...
    private val v2buf: FloatBuffer = BufferUtils.createFloatBuffer(2)
    private val v3buf: FloatBuffer = BufferUtils.createFloatBuffer(3)
    /**
